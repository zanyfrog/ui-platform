...
for (const file of files) {
  ...
  for (const marker of ['Development identity', 'uib-editor-identity-change', '/api/editor/session', 'x-editor-revision', 'dev-admin', 'admin@uib.test', 'Generic Artifact Editor', 'Authorize and compare for recovery', 'Editor plugin failed', 'No compatible property descriptor', 'Permanent field ID']) {
